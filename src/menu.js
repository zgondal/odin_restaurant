...
const baseLayout = (category) => {
    ...
    imgOne.setAttribute("src", `${category.itemOne.name}.jpg`);
    itemOne.appendChild(imgOne);
    const descOne = document.createElement("span");
    descOne.textContent = `${category.itemOne.description}`;
    itemOne.appendChild(descOne);
    container.appendChild(itemOne);
    const itemTwo = document.createElement("div");
    itemTwo.classList.add("item");
    const imgTwo = document.createElement("img");
    imgTwo.setAttribute("src", `${category.itemTwo.name}.jpg`);
    const descTwo = document.createElement("span");
    descTwo.textContent = `${category.itemTwo.description}`;
